...
#### The plot
The program generates two plots.  The first shows the players' mistake distributions using Gaussian kernel density
...
The second shows the expected result for the game for each turn combined with two graphs that show each player's worst
ten moves:
